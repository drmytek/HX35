...
HX3.5 Editor's "Update/Finalize Panel". Voice Presets will be lost with 
"Firmware/EEPROM Update".
...
itself). If you want to retain previous split function (affects sound 
generator), do not update Scan Driver or use #16 (enclosed). 
